...
<body>
	<form method="post" action="/lesson02/ex03_1.jsp">
		...
		<label>
			민트초코<input type="checkbox" name="food" value="민트초코">
			<!-- value: 데이터에 넘기려고 -->
		</label>
		<label>
			하와이안 피자(파인애플)<input type="checkbox" name="food" value="하와이안 피자(파인애플)">
		</label>
		<label>
			번데기<input type="checkbox" name="food" value="번데기">
		</label>
		<br><br>
		
		5. 좋아하는 과일을 선택하세요.<br>
		<select name="fruit">
			<option>사과</option> <!-- value를 넣으면 태그안 텍스트말고 벨류값이 나옴 -->
			<option>바나나</option>
			<option>복숭아</option>
			<option>딸기</option>
			<option>포도</option>
